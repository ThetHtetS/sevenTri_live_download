  ...
  return (
    <>
      <div className="bg-[#283A4A] lg:h-auto h-screen">
        ...
        <div className="flex lg:h-screen  bg-[#283A4A]  lg:justify-evenly flex-col-reverse md:flex-col-reverse lg:flex-row items-center justify-center md:mt-20 lg:mt-0 ">
